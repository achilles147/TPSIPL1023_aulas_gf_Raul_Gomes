...
peso_total = float(input("Introduza o pêso total: "))

print(f"Foram pescados {peso_total} quilos.")

print("Estiveram em excedente", peso_total - 50, "quilos.")

print("A multa aplicada será ", (peso_total - 50) * 4, "reais.")
